...
#define CREATE_SIMD_FUNCTIONS( TYPE ) \
    ...
    INLINE BoolVector operator<  ( TYPE lhs, TYPE rhs ) { return BoolVector(XMVectorLess(lhs, rhs)); } \
    INLINE BoolVector operator<= ( TYPE lhs, TYPE rhs ) { return BoolVector(XMVectorLessOrEqual(lhs, rhs)); } \
    INLINE BoolVector operator>  ( TYPE lhs, TYPE rhs ) { return BoolVector(XMVectorGreater(lhs, rhs)); } \
    INLINE BoolVector operator>= ( TYPE lhs, TYPE rhs ) { return BoolVector(XMVectorGreaterOrEqual(lhs, rhs)); } \
    INLINE BoolVector operator== ( TYPE lhs, TYPE rhs ) { return BoolVector(XMVectorEqual(lhs, rhs)); } \
